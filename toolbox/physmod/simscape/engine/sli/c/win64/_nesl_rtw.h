...
initer->mRefCount)==0){initer->mDestroy(initer);}}}
#ifdef __cplusplus
}
#endif /* __cplusplus */
#include "ne_stiffness_fwd.h"
...
IterationsLogCore*il);NeStiffness*(*mGetStiffness)(const Simulator*s);void(*
mDestroy)(Simulator*solver);};Simulator*simulator_create(SwitchedLinearSystem*
sls,const NeSolverParameters param,const McLinearAlgebraFactory*la,const
NeVariableData*vardata,const NeObservableData*obsdata,const size_t
numObservables,const DaemonChoice dc);
#ifdef __cplusplus
}
#endif /* __cplusplus */
#include "ne_std.h"
